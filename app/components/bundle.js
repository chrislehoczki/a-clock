...
function CityMap(el, data, width, height, radius, hoverRadius) {
    ...
    this.appendSvg = function () {
        ...
        this.SVG = d3.select(el).append("svg").attr("width", width).attr("height", height).classed("SVG", true);
        ...
        var zoom = d3.behavior.zoom().on("zoom", function () {
            self.g.attr("transform", "translate(" + d3.event.translate.join(",") + ")scale(" + d3.event.scale + ")");
        ...
        d3.json('https://raw.githubusercontent.com/mbostock/topojson/master/examples/world-110m.json', function (json) {
            self.g.selectAll('path') //act on all path elements
            .data(topojson.feature(json, json.objects.countries).features) //get data
            .enter() //add to dom
            .append('path').attr('fill', '#95E1D3').attr('stroke', '#266D98').attr('d', path).classed("map-path", true);
        ...
        var self = this;
        this.circles = this.g.selectAll("circle").data(data).enter().append("circle").attr('cx', function (d) {
            return self.projection([d.info.location.longitude, d.info.location.latitude])[0];
        }).attr('cy', function (d) {
            return 0;
        }).classed("circle", true).attr("r", function (d) {
            return radius;
        }).style("fill", function (d) {
            return "rgb(58, 193, 98)";
        }).style("opacity", "1");

        this.circles.transition().duration(1000).attr('cx', function (d) {
            return self.projection([d.info.location.longitude, d.info.location.latitude])[0];
        }).attr('cy', function (d) {
            return self.projection([d.info.location.longitude, d.info.location.latitude])[1];
        });
        ...
        this.circles.on("mouseover", function (d) {
            d3.select(this).transition().duration(600).attr("r", function (d) {
                return hoverRadius;
            });
        ...
        this.tooltip.transition().duration(600).style("opacity", 0.95).style("left", function () {
            return mouseCoords[0] - 150 + "px";
        }).style("top", function () {
            return mouseCoords[1] + 50 + "px";
        });

        this.tooltip.html("<a href=" + "'/city/" + d.info.city.slug + "'" + "><h4>" + d.info.city.name + ", " + d.info.country.name + "</h4><h4>Runners: " + d.running.runnerCount + "</h4><h4>Riders: " + d.riding.riderCount + "</h4></a>");
    };
}
...
},{"./Cities.js":4,"./filter/Altitude.js":23,"./filter/Continent.js":24,"./filter/Hotel.js":25,"./filter/Month.js":26,"./filter/Rain.js":27,"./filter/Sort.js":28,"./filter/Temp.js":29,"./filter/Terrain.js":30}],8:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./IntroText.js":9,"./Login.js":10,"./Signup.js":14,"./addcity/AddCityModal.js":17,"./single/Overview.js":43}],9:[function(require,module,exports){
(function (global){
"use strict";
...
var SignupModal = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            React.createElement(
                Modal,
                { style: center, show: this.props.showMessage, onHide: this.props.hideMessage },
                React.createElement(
                    Modal.Body,
                    { style: center },
                    React.createElement(
...
},{"./Cities.js":4,"./Filter.js":7,"./map/Map.js":32}],12:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./searchbox/Option.js":35}],13:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./SearchBox.js":12,"./data-display/DataDisplay.js":21}],14:[function(require,module,exports){
(function (global){
"use strict";
...
var Single = React.createClass({
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            !this.props.addCity ? React.createElement(
                "div",
            ...
            React.createElement(
                ...
                React.createElement(Weather, { container: this.props.weatherContainer, city: this.state.data.info.city.name, weather: this.state.data.weather, data: this.state.data })
            ),
            React.createElement(
                "div",
...
},{"./CityImage.js":6,"./single/CityGuides.js":36,"./single/Description.js":38,"./single/Groups.js":41,"./single/Nutrition.js":42,"./single/Segments.js":46,"./single/Tips.js":48,"./single/UserForm.js":50,"./single/Users.js":51,"./single/Weather.js":52}],16:[function(require,module,exports){
(function (global){
"use strict";
...
var Header = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(AddCityModal, { showMessage: this.state.showAddCityModal, hideMessage: this.hideAddCityModal }),
      React.createElement(ProfileModal, { user: this.props.user, showMessage: this.state.showProfileModal, hideMessage: this.hideProfileModal })
    );
  }
});
...
},{"./IntroText.js":9,"./Login.js":10,"./Signup.js":14,"./addcity/AddCityModal.js":17,"./profile/ProfileModal.js":34,"./single/Overview.js":43}],17:[function(require,module,exports){
(function (global){
"use strict";
...
var Location = React.createClass({
      ...
      render: function render() {
            return React.createElement(
                  ...
                  React.createElement(
                        "button",
                        { onClick: this.declareCity, className: "btn filter-btn auto-width" },
      ...
      React.createElement(
        ...
        React.createElement(
          ...
          this.state.success ? React.createElement(
            ...
            React.createElement(
              "button",
              { onClick: this.tweetIt, className: "btn main-btn" },
              "Tweet Your Friends"
            )
          ) : null,
...
},{"./TopCity.js":22}],22:[function(require,module,exports){
(function (global){
"use strict";
...
if (mainHolder) {
	...
	ReactDOM.render(React.createElement(Single, { data: data, weatherContainer: "chart" }), singleHolder);
}

}).call(this,typeof global !== "undefined" ? global : typeof self !== "undefined" ? self : typeof window !== "undefined" ? window : {})
},{"./Header.js":8,"./Main.js":11,"./Sidebar.js":13,"./Single.js":15,"./UserHeader.js":16}],32:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../../common/MapChart.js":2}],33:[function(require,module,exports){
(function (global){
'use strict';
...
var Profile = React.createClass({
  ...
  render: function render() {
    ...
    return React.createElement(
      ...
      React.createElement(
        Modal,
        { dialogClassName: "profileModal", onEntering: this.getUser, show: this.props.showMessage, backdrop: true, keyboard: true, onHide: this.props.hideMessage },
        React.createElement(
          Modal.Header,
          { closeButton: true },
          React.createElement(
        ...
        React.createElement(
          ...
          this.state.user.guideCities.length > 0 ? this.state.user.guideCities.map(function (city) {
          ...
          this.state.user.tips.length > 0 ? this.state.user.tips.map(function (tip) {
        ...
        React.createElement(
          ...
          React.createElement(
            "button",
            { className: "btn main-btn", onClick: this.props.hideMessage },
            "Close"
          )
        )
      )
...
},{"./GuideCity.js":33}],35:[function(require,module,exports){
(function (global){
"use strict";
    ...
    render: function render() {
        ...
        return React.createElement(
            ...
            this.props.data.guides.length > 0 ? this.props.data.guides.map(function (guide) {
                return React.createElement(Guide, { data: guide });
            }) : React.createElement(
                "p",
                null,
...
},{"../city-guides/CityGuideInfo.js":19,"../city-guides/Guide.js":20}],37:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./UserForm.js":50}],39:[function(require,module,exports){
(function (global){
"use strict";
...
},{"../../common/description.js":3}],40:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./Controls.js":37,"./Group.js":40}],42:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./Restaurant.js":44}],43:[function(require,module,exports){
(function (global){
"use strict";
...
},{"./Controls.js":37,"./Segment.js":45}],47:[function(require,module,exports){
(function (global){
'use strict';
...
},{"./Controls.js":37,"./Tip.js":47,"./UserForm.js":50}],49:[function(require,module,exports){
(function (global){
'use strict';
        ...
        return React.createElement(
            ...
            this.state.type === "running" ? React.createElement(
                ...
                this.props.runners.map(function (runner) {
                    return React.createElement(User, { key: Math.random(), athlete: runner });
                })
            ) : null,
            this.state.type === "riding" ? React.createElement(
                "div",
...
},{"./Controls.js":37,"./User.js":49}],52:[function(require,module,exports){
(function (global){
"use strict";
...
var Weather = React.createClass({
    ...
    componentDidMount: function componentDidMount() {
        ...
        function makeChart() {
            ...
            //CREATE SVG
            svg = d3.select(containerId).append("svg").attr("width", width + margin.left + margin.right).attr("height", height + margin.top + margin.bottom).append("g").attr("transform", "translate(" + margin.left + "," + margin.top + ")").classed("weather-svg", true);
