function CityMap (el, data, width, height, radius, hoverRadius) {
    ...
    this.addData = function (data) {
      ...
      this.circles =  this.g.selectAll("circle")
           ...
           .enter()
           .append("circle")
          .attr('cx', function(d) { return self.projection([d.info.location.longitude,d.info.location.latitude])[0] })
      ...
      this.circles.transition().duration(1000).attr('cx', function(d) { return self.projection([d.info.location.longitude,d.info.location.latitude])[0] })
          .attr('cy', function(d) { return self.projection([d.info.location.longitude,d.info.location.latitude])[1] })
    },
